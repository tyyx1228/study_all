package com.ty.study.recommender.mahout;
...
public class BaseItemRecommender {
    ...
    public static void main(String[] args) throws Exception {
        //System.out.println(BaseItemRecommender.class.getResource("/"));
        //准备数据 这里是电影评分数据
//        File file = new File("E:\\WorkSpace\\idea\\study_all1\\bd_storm\\stormApi-recommender\\data\\sample_movielens_ratings.txt");
        File file = new File("E:\\test-data\\ml-10M100K\\ratings.dat");
        ...
        List<RecommendedItem> recommendedItemList = recommender.recommendedBecause(6,2398, 10);
        //打印推荐的结果
