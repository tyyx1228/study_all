...
public class SimpleZkClient {
	...
	private static final String connectString = "hdp10:2181,hdp11:2181,hdp12:2181";
	...
	public void testCreate() throws KeeperException, InterruptedException {
		...
		/****tongyu test getdata
		byte[] zklist = zkClient.getData("/eclipse", false, null);
		System.out.println(new String(zklist));
		
		tongyu test getChildren 获取子节点
