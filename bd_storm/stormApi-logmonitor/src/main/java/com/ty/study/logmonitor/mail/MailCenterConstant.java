package com.ty.study.logmonitor.mail;
...
public class MailCenterConstant implements Serializable {
    ...
    public final static String FROM_ADDRESS = "wjymaoxiangyi@163.com";
    public final static String USER = "wjymaoxiangyi@163.com";
    public final static String PWD = "striver";
}
