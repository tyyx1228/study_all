package com.ty.study.flowanalyse;
...
public class LogEnhancerOutputFormat extends FileOutputFormat<Text, NullWritable> {
	...
	public RecordWriter<Text, NullWritable> getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
		Path enhaPath = new Path("hdfs://hdp01:9000/flow/enhance/enhanced.log");
		Path tocrawlPath = new Path("hdfs://hdp01:9000/flow/tocrawl/tocrawl.dat");
